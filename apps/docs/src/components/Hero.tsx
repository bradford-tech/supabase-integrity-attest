...
const code = `import { verifyAttestation } from '@bradford-tech/supabase-integrity-attest'
...
const tabs = [{ name: 'attestation.ts', isActive: true }]
          ...
          <div className="relative z-10 md:text-center lg:text-left">
            ...
            <div className="relative">
              ...
              <div className="mt-8 flex gap-4 md:justify-center lg:justify-start">
                ...
                <Button
                  href="https://github.com/bradford-tech/supabase-integrity-attest"
                  variant="secondary"
                  target="_blank"
